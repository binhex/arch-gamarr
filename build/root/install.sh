...
pacman_packages="git python python-pip python-uv xorg-server-xvfb ncurses tk chromium"
...
github.sh --install-path "${install_path}" --github-owner 'binhex' --github-repo 'gamarr' --query-type 'release' --download-branch 'main'
...
install_paths="/opt/gamarr,/home/nobody"
...
env_vars=(
	"GAMARR_LOG_LEVEL:INFO:false:false"
	"GAMARR_LIBRARY_PATH::false:false"
	"GAMARR_QBT_HOST::true:false"
	"GAMARR_QBT_PORT::true:false"
	"GAMARR_QBT_USERNAME::true:false"
	"GAMARR_QBT_PASSWORD::true:true"
	"GAMARR_CONFIG_PATH::false:false"
	"GAMARR_DB_PATH::false:false"
	"GAMARR_LOG_PATH::false:false"
	"GAMARR_PID_PATH::false:false"
